...
.party_info
	db 90
	dw KOKOPELLI, SHARPEN, HARDEN, POUND, GROWTH
	db 50
	dw EXEGGUTOR, POUND, CUT, DOUBLE_TEAM, SURF
	db 50
	dw MEW, SWORDS_DANCE, POUND, AGILITY, CUT
	db 50
	dw MEWTWO, AMNESIA, POUND, CUT, SURF
	db 1
	dw PICHU, STEEL_WING, METAL_CLAW, ANCIENTPOWER, SKULL_BASH
	db 0
