...
; jumptable constants
	...
	const VFLIP_QUIT
DEF VFLIP_END_LOOP_F EQU 7

DEF VFLIP_NUMTILE_1 EQU $0c
DEF VFLIP_NUMTILE_2 EQU $0d
DEF VFLIP_NUMTILE_3 EQU $0e

DEF VFLIP_RIGHT_NOTE EQU 2
DEF VFLIP_LEFT_NOTE  EQU 3
DEF VFLIP_UP_NOTE    EQU 4
DEF VFLIP_DOWN_NOTE  EQU 5
