...
MovesGen1:
	...
	move EFFECT_RAZOR_WIND,         80, NORMAL,        PHYSICAL,  75, 10,   0      ;RAZOR_WIND
	move EFFECT_ATTACK_UP_2,         0, NORMAL,        PHYSICAL, 100, 30,   0      ;SWORDS_DANCE
...
MovesGroup3:
	move EFFECT_NORMAL_HIT,         40, NORMAL,        PHYSICAL, 100, 40,   0      ;FAKE_OUT
.IndirectEnd::
