...
MapGroup_Dungeons:
	...
	map MossyWoods, TILESET_FOREST, CAVE, LANDMARK_MOSSY_WOODS, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Shale:
	...
	map RouteN02DayCare, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_N02, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RouteN02MossyWoodsGate, TILESET_GATE, GATE, LANDMARK_ROUTE_N02, MUSIC_ROUTE_26, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_SHALE_MAPS

MapGroup_Chert:
	table_width MAP_LENGTH, MapGroup_Chert
	map ChertCity, TILESET_JOHTO, TOWN, LANDMARK_CHERT_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map ChertCityMossyWoodsGate, TILESET_GATE, GATE, LANDMARK_CHERT_CITY, MUSIC_ROUTE_26, FALSE, PALETTE_DAY, FISHGROUP_SHORE
