...
; wStatusFlags
	...
	const ENGINE_FIRST_TIME_OUTSIDE
; wStatusFlags2
	const ENGINE_BUG_CONTEST_TIMER
	const ENGINE_BADGE_CASE
...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_OBSIDIAN
	const ENGINE_FLYPOINT_SHALE
	const ENGINE_FLYPOINT_CHERT
...
; wUnlockedDexFlags
	const ENGINE_UNLOCKED_NAZOH_DEX
	const ENGINE_UNLOCKED_HOLON_DEX
	const ENGINE_UNLOCKED_NATIONAL_DEX
; wTrainerStars
...
DEF ENGINE_BADGE_CUT        EQU ENGINE_BADGE2
DEF ENGINE_BADGE_FLY        EQU ENGINE_BADGE6
DEF ENGINE_BADGE_SURF       EQU ENGINE_BADGE4
DEF ENGINE_BADGE_STRENGTH   EQU ENGINE_BADGE3
DEF ENGINE_BADGE_DIVE       EQU ENGINE_BADGE7
DEF ENGINE_BADGE_ROCK_SMASH EQU ENGINE_BADGE5
DEF ENGINE_BADGE_WATERFALL  EQU ENGINE_BADGE8
